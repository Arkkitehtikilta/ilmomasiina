            ...
            <div className="row">
              <div className="col-xs-12 col-sm-8">
                ...
                <p className="description">
                  {description}</p>
                  <hr/>
                  <p>Ilmoittautumisen sulkeuduttua ilmoittautuminen on sitova. Tämän jälkeen ilmoittautunut on velvollinen maksamaan osallistumismaksun tai löytämään paikalleen toisen osallistujan. Osallistumalla tapahtumaan sitoudut noudattamaan <a href="/periaatteet">Arkkitehtikillan yhteisiä periaatteita</a>.</p>

                  <p>The sign up is binding when sign-up closes. After this, the person who has signed up is obligated to pay the participation fee or find another participant to attend in one’s place. <a href="/principles">The Guild of Architectures common principles</a> are to be followed in the event.</p>
                  <hr/>
